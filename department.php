								...
								<div id="edit<?= $row['ID']; ?>" class="modal fade" tabindex="-1">
									<div class="modal-dialog modal-dialog-centered">
										<div class="modal-content">
											...
											<form action="action/department-action.php" method="POST" autocomplete="off">
													...
													<div class="form-group">
														<div class="row">
															<div class="col-sm-12">
																...
																<input type="text" class="form-control" name="department" required value="<?= $row['Department']; ?>">
															</div>
														</div>
													</div>
												</div>
					...
					<div class="modal-body">
						<div class="form-group">
							<div class="row">
								<div class="col-sm-12">
									<label class="font-weight-semibold">Department</label>
									<input type="text" class="form-control" name="department" required placeholder="STEM">
								</div>
							</div>
						</div>
					</div>
