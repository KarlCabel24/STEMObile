							...
							?>
								<tr>
									...
									<td class="text-center">
										<?php 
											$sqll = 'SELECT ID, StudentID FROM tbl_assign_score where AssignmentID = ? AND StudentID = ?'; 
										...
										<?php } else { ?>
										<a href="assignment-question.php?assignmentID=<?=$row['ID'];?>&qno=1" class="btn btn-outline-primary">Start</a>
										<?php } ?>
									</td>
								</tr>
							<?php } ?>
