								...
								<div id="edit<?= $row['ID']; ?>" class="modal fade" tabindex="-1">
									<div class="modal-dialog modal-dialog-centered">
										<div class="modal-content">
											...
											<form action="action/teacher-subject-action.php" method="POST" autocomplete="off">
												<div class="modal-body">
													<div class="form-group">
														<div class="row">
									                        <div class="col-sm-12">
									                            <label class="font-weight-semibold">Subject</label>
									                            <select data-placeholder="-SELECT-" class="form-control form-control-select2" name="subjectID" data-fouc required>
									                                ...
									                                <?php
																		...
																		$stmt4->execute([$row['SubjectID']]);

																		while($row4 = $stmt4->fetch()){
																	?>
									                                <option value="<?= $row4['ID']; ?>"><?= $row4['Subject']; ?></option>
		                        ...
		                        <div class="col-sm-12">
		                            ...
		                            <select data-placeholder="-SELECT-" class="form-control form-control-select2" name="sectionOption" data-fouc required>
		                                ...
		                                <option value="<?= $row1['ID']; ?>"
		                                		data-schoolyear="<?= $row1['SchoolYear']; ?>"><?= $row1['Grade'] .' - '. $row1['Section'] .' | '. $row1['SchoolYear']; ?></option>
