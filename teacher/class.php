										...
										<div class="list-icons">
											<div class="dropdown">
												...
												<div class="dropdown-menu dropdown-menu-right">
													<a href="class-subject.php?sectionID=<?=$row['SectionID'];?>" class="dropdown-item"><i class="icon-books"></i> Subject</a>
													<a href="class-student.php?sectionID=<?=$row['SectionID'];?>" class="dropdown-item"><i class="icon-users"></i> Student</a>
