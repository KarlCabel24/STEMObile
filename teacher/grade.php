								...
								<div id="edit<?= $row['ID']; ?>" class="modal fade" tabindex="-1">
									<div class="modal-dialog modal-dialog-centered">
										<div class="modal-content">
											...
											<form action="action/grade-action.php" method="POST" autocomplete="off">
													...
													<div class="form-group">
														<div class="row">
															<div class="col-sm-12">
																...
																<input type="text" class="form-control" name="gradeLevel" required value="<?= $row['Grade']; ?>">
															</div>
														</div>
													</div>
												</div>
					...
					<div class="modal-body">
						<div class="form-group">
							<div class="row">
								<div class="col-sm-12">
									<label class="font-weight-semibold">Grade Level</label>
									<input type="text" class="form-control" name="gradeLevel" required placeholder="Grade 11">
								</div>
							</div>
						</div>
					</div>
