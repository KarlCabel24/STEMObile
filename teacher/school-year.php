								...
								<div id="edit<?= $row['ID']; ?>" class="modal fade" tabindex="-1">
									<div class="modal-dialog modal-dialog-centered">
										<div class="modal-content">
											...
											<form action="action/school-year-action.php" method="POST" autocomplete="off">
													...
													<div class="form-group">
														<div class="row">
															<div class="col-sm-12">
																...
																<input type="text" class="form-control" name="schoolYear" required value="<?= $row['SchoolYear']; ?>">
															</div>
														</div>
													</div>
												</div>
					...
					<div class="modal-body">
						<div class="form-group">
							<div class="row">
								<div class="col-sm-12">
									<label class="font-weight-semibold">School Year</label>
									<input type="text" class="form-control" name="schoolYear" required placeholder="2023-2024">
								</div>
							</div>
						</div>
					</div>
